...
This file preserves evidence from successive implementation checkpoints. Statements
about unfinished work describe their checkpoint, not the current port. See
[VALIDATION.md](VALIDATION.md) for current results and outstanding checks.
